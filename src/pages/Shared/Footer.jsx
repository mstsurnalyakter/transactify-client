...
const Footer = () => {
  return (
    <footer className="px-4 divide-y bg-[#20A1A9] text-black py-4">
        ...
        <div className="lg:w-1/3">
          <div className="flex justify-center space-x-3 lg:justify-start">
            <div className="self-center gap-2 flex items-center text-lg md:text-2xl font-semibold">
              <img
                className="w-12 rounded-full border-2 bg-white border-[#20A1A9] p-1"
                src={logo}
                alt=""
              />
              <h2 className="mt-3">Transactify</h2>
            </div>
          </div>
        </div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  ...
                  <span>transactify@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
      ...
      <div className="py-6 text-sm text-center dark:text-gray-600">
        <p className="text-black font-medium">
          ...
          <span className="font-extrabold">Transactify</span>
        </p>
      </div>
    </footer>
  );
